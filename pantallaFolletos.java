...
public class pantallaFolletos extends javax.swing.JFrame {
     ...
     */
        ...
        String rutaverano = "C:\\Publicaciones\\Folletos\\Verano";
        ...
        System.arraycopy(verano, 0, imagenes, enero.length+invierno.length, verano.length);
        ...
        for (int i = 0; i < listOfFiles.length; i++) {
            ...
            if (listOfFiles[i].isDirectory()) {
                ...
                for (int c = 0; c < listadearchivos.length; c++) {
                    if (listadearchivos[c].isFile()) {
                        img = listadearchivos[c].getPath();
                        archivo[cont] = img;
                        cont++;
                        break;
    ...
    private void initComponents() {
        ...
        folleto6.setText(" ");
        folleto6.setPreferredSize(new java.awt.Dimension(240, 309));
        ...
        panel2Layout.setHorizontalGroup(
            ...
            .addGroup(panel2Layout.createSequentialGroup()
                ...
                .addGroup(panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(folleto5, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(206, 206, 206)
                .addGroup(panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void panel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel4MouseClicked
       ...
       indicex--;
        ...
        if (img[indicex]!=null){
         try {
                if (img[indicex] != null) {
                    folleto6.setIcon(new ImageIcon(img[indicex]));
                    lblf6.setText(imagenes[indicex]);
                    lblf6.setVisible(false);
                } else {
                    folleto6.setVisible(false);
                }
         ...
         indicex--;
            try {
                if (img[indicex] != null) {
                    folleto5.setIcon(new ImageIcon(img[indicex]));
                     lblf5.setText(imagenes[indicex]);
                     lblf5.setVisible(false);
                } else {
                    folleto5.setVisible(false);
                }                
            ...
            try {
                if (img[indicex] != null) {
                    folleto4.setIcon(new ImageIcon(img[indicex]));
                     lblf4.setText(imagenes[indicex]);
                     lblf4.setVisible(false);
                } else {
                    folleto4.setVisible(false);
                }
            ...
            try {
                if (img[indicex] != null) {
                    folleto3.setIcon(new ImageIcon(img[indicex]));
                     lblf3.setText(imagenes[indicex]);
                    lblf3.setVisible(false);
                } else {
                    folleto3.setVisible(false);
                }
            ...
            try {
                if (img[indicex] != null) {
                    folleto2.setIcon(new ImageIcon(img[indicex]));
                     lblf2.setText(imagenes[indicex]);
                     lblf2.setVisible(false);
                } else {
                    folleto2.setVisible(false);
                }
            ...
            try {
                if (img[indicex] != null) {
                    folleto1.setIcon(new ImageIcon(img[indicex]));
                     lblf1.setText(imagenes[indicex]);
                     lblf1.setVisible(false);
                } else {
                    folleto1.setVisible(false);
                }
...
int ultimapos;
    ...
    private void folleto5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_folleto5ActionPerformed
        ...
        try {
                // TODO add your handling code here:
                new pantallaFolletosDespliegue(lblf6.getText()).setVisible(true);
            } catch (IOException ex) {
                Logger.getLogger(pantallaFolletos.class.getName()).log(Level.SEVERE, null, ex);
            }
